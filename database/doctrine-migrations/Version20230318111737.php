 ...
 */
final class Version20230318111737 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id CHAR(36) NOT NULL, name VARCHAR(100) NOT NULL, username VARCHAR(100) NOT NULL, email VARCHAR(320) NOT NULL, phone VARCHAR(100) NOT NULL, website VARCHAR(2048) NOT NULL, address_street VARCHAR(100) NOT NULL, address_suite VARCHAR(100) NOT NULL, address_city VARCHAR(100) NOT NULL, address_zipcode VARCHAR(20) NOT NULL, address_geoLocation_latitude DOUBLE PRECISION NOT NULL, address_geoLocation_longitude DOUBLE PRECISION NOT NULL, company_name VARCHAR(100) NOT NULL, company_catchphrase VARCHAR(100) NOT NULL, company_bs VARCHAR(100) NOT NULL, INDEX idx_id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
